...
function initDb() {
  db.exec(`
    ...
    INSERT OR IGNORE INTO templates (id, name, category, description, image, price) VALUES
      ('tpl-01', 'Business Pitch Deck', 'Presentation', 'Clean modern pitch deck with 12 slides for startups and entrepreneurs.', 'https://picsum.photos/seed/pitch1/400/300', 29),
      ('tpl-02', 'Brand Style Guide', 'Presentation', 'Professional brand identity presentation with color palettes and typography.', 'https://picsum.photos/seed/style1/400/300', 35),
      ('tpl-03', 'Conference Talk', 'Presentation', 'Bold conference presentation template for keynote speeches and talks.', 'https://picsum.photos/seed/conf1/400/300', 19),
      ('tpl-04', 'Creative Poster', 'Poster', 'Artistic poster template for events, concerts, and exhibitions.', 'https://picsum.photos/seed/poster1/400/300', 15),
      ('tpl-05', 'Academic Poster', 'Poster', 'Research poster template for conferences and academic presentations.', 'https://picsum.photos/seed/poster2/400/300', 12),
      ('tpl-06', 'Corporate Poster', 'Poster', 'Professional corporate poster for business announcements.', 'https://picsum.photos/seed/poster3/400/300', 18),
      ('tpl-07', 'Modern Resume', 'Resume', 'Clean modern resume template with skills section and timeline.', 'https://picsum.photos/seed/resume1/400/300', 9),
      ('tpl-08', 'Creative CV', 'Resume', 'Colorful creative CV for designers and creative professionals.', 'https://picsum.photos/seed/resume2/400/300', 12),
      ('tpl-09', 'Executive Resume', 'Resume', 'Professional executive resume with clean typography.', 'https://picsum.photos/seed/resume3/400/300', 14),
      ('tpl-10', 'Welcome Email', 'Email', 'Beautiful welcome email template for new subscribers.', 'https://picsum.photos/seed/email1/400/300', 8),
      ('tpl-11', 'Newsletter', 'Email', 'Professional newsletter template with multiple content sections.', 'https://picsum.photos/seed/email2/400/300', 10),
      ('tpl-12', 'Promotional Email', 'Email', 'Sales and promotional email template with call-to-action.', 'https://picsum.photos/seed/email3/400/300', 8),
      ('tpl-13', 'Wedding Invitation', 'Invitation', 'Elegant wedding invitation with floral design.', 'https://picsum.photos/seed/invite1/400/300', 15),
      ('tpl-14', 'Birthday Invitation', 'Invitation', 'Fun birthday party invitation with confetti design.', 'https://picsum.photos/seed/invite2/400/300', 12),
      ('tpl-15', 'Event Invitation', 'Invitation', 'Modern event invitation for galas and corporate events.', 'https://picsum.photos/seed/invite3/400/300', 14),
      ('tpl-16', 'TikTok Intro', 'Mobile Video', 'Viral TikTok intro template with animated text.', 'https://picsum.photos/seed/mvideo1/400/300', 10),
      ('tpl-17', 'Instagram Reel', 'Mobile Video', 'Trendy Instagram Reel template with transitions.', 'https://picsum.photos/seed/mvideo2/400/300', 12),
      ('tpl-18', 'YouTube Short', 'Mobile Video', 'Vertical YouTube Short template for quick content.', 'https://picsum.photos/seed/mvideo3/400/300', 10),
      ('tpl-19', 'Product Launch', 'Facebook Post', 'Facebook post template for product launches and announcements.', 'https://picsum.photos/seed/fb1/400/300', 8),
      ('tpl-20', 'Quote Card', 'Facebook Post', 'Inspirational quote card template for Facebook engagement.', 'https://picsum.photos/seed/fb2/400/300', 6),
      ('tpl-21', 'Business Card Classic', 'Business Card', 'Classic business card with minimalist design.', 'https://picsum.photos/seed/bcard1/400/300', 10),
      ('tpl-22', 'Modern Business Card', 'Business Card', 'Contemporary business card with bold colors.', 'https://picsum.photos/seed/bcard2/400/300', 12),
      ('tpl-23', 'Photo Collage Grid', 'Photo Collage', 'Grid-based photo collage template for memories.', 'https://picsum.photos/seed/collage1/400/300', 8),
      ('tpl-24', 'Mood Board', 'Photo Collage', 'Creative mood board collage for design inspiration.', 'https://picsum.photos/seed/collage2/400/300', 10),
      ('tpl-25', 'Whiteboard Explainer', 'Whiteboard', 'Whiteboard animation template for explainer videos.', 'https://picsum.photos/seed/board1/400/300', 25),
      ('tpl-26', 'Brainstorm Template', 'Whiteboard', 'Brainstorming whiteboard template for team sessions.', 'https://picsum.photos/seed/board2/400/300', 20),
      ('tpl-27', 'Invoice Sheet', 'Sheet', 'Professional invoice template for freelancers.', 'https://picsum.photos/seed/sheet1/400/300', 8),
      ('tpl-28', 'Budget Tracker', 'Sheet', 'Personal budget tracking spreadsheet template.', 'https://picsum.photos/seed/sheet2/400/300', 6),
      ('tpl-29', 'IG Story Poll', 'Instagram Story', 'Interactive Instagram Story with poll and quiz stickers.', 'https://picsum.photos/seed/igstory1/400/300', 7),
      ('tpl-30', 'IG Story Highlight', 'Instagram Story', 'Custom Instagram Story highlight cover template.', 'https://picsum.photos/seed/igstory2/400/300', 5),
      ('tpl-31', 'Product Post', 'Instagram Post', 'Minimalist product showcase for Instagram feed.', 'https://picsum.photos/seed/igpost1/400/300', 8),
      ('tpl-32', 'Carousel Post', 'Instagram Post', 'Multi-slide Instagram carousel template for tutorials.', 'https://picsum.photos/seed/igpost2/400/300', 10),
      ('tpl-33', 'YouTube Thumbnail', 'Landscape Video', 'Eye-catching YouTube thumbnail template.', 'https://picsum.photos/seed/land1/400/300', 8),
      ('tpl-34', 'Video Intro', 'Landscape Video', 'Professional video intro template for YouTube.', 'https://picsum.photos/seed/land2/400/300', 15),
      ('tpl-35', 'Code Snippet', 'Code', 'Clean code snippet template with syntax highlighting.', 'https://picsum.photos/seed/code1/400/300', 6),
      ('tpl-36', 'API Documentation', 'Code', 'Professional API documentation page template.', 'https://picsum.photos/seed/code2/400/300', 12),
      ('tpl-37', 'Event Flyer', 'Flyer', 'Bold event flyer for parties, clubs, and concerts.', 'https://picsum.photos/seed/flyer1/400/300', 12),
      ('tpl-38', 'Promo Flyer', 'Flyer', 'Promotional flyer template with discount offers.', 'https://picsum.photos/seed/flyer2/400/300', 10),
      ('tpl-39', 'Real Estate Flyer', 'Flyer', 'Real estate property listing flyer template.', 'https://picsum.photos/seed/flyer3/400/300', 14),
      ('tpl-40', 'Minimalist Logo', 'Logo', 'Clean minimalist logo template for modern brands.', 'https://picsum.photos/seed/logo1/400/300', 25),
      ('tpl-41', 'Luxury Logo', 'Logo', 'Elegant luxury logo with gold accents.', 'https://picsum.photos/seed/logo2/400/300', 35),
      ('tpl-42', 'Tech Logo', 'Logo', 'Modern technology logo with geometric shapes.', 'https://picsum.photos/seed/logo3/400/300', 30),
      ('tpl-43', 'Corporate Brochure', 'Brochure', 'Tri-fold corporate brochure for company profiles.', 'https://picsum.photos/seed/bro1/400/300', 20),
      ('tpl-44', 'Travel Brochure', 'Brochure', 'Colorful travel brochure with destination highlights.', 'https://picsum.photos/seed/bro2/400/300', 18),
      ('tpl-45', 'Restaurant Menu', 'Menu', 'Elegant restaurant menu with food photography.', 'https://picsum.photos/seed/menu1/400/300', 15),
      ('tpl-46', 'Cafe Menu', 'Menu', 'Modern cafe menu with handwritten font style.', 'https://picsum.photos/seed/menu2/400/300', 12),
      ('tpl-47', 'Proposal Doc', 'Doc', 'Professional business proposal document template.', 'https://picsum.photos/seed/doc1/400/300', 18),
      ('tpl-48', 'Report Template', 'Doc', 'Annual report template with charts and data sections.', 'https://picsum.photos/seed/doc2/400/300', 22),
      ('tpl-49', 'Portfolio Website', 'Websites', 'Personal portfolio website template for creatives.', 'https://picsum.photos/seed/web1/400/300', 49),
      ('tpl-50', 'Business Website', 'Websites', 'Professional business website template with 5 pages.', 'https://picsum.photos/seed/web2/400/300', 79);
